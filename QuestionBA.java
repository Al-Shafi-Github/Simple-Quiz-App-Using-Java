...
public class QuestionBA extends JFrame {
	...
	public static void main() {
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					QuestionBA frame = new QuestionBA();
	 ...
	 * Create the frame.
	 */
	public QuestionBA()throws IOException{
		p=new BangladeshAffairs();
		setTitle("Bangladesh Affairs");
		setIconImage(Toolkit.getDefaultToolkit().getImage(QuestionBA.class.getResource("/javax/swing/plaf/metal/icons/ocean/computer.gif")));
		...
		confirmBut.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				String A1=((BangladeshAffairs)p).getA1();
				String A2=((BangladeshAffairs)p).getA2();
				String A3=((BangladeshAffairs)p).getA3();
...
quesBut.addActionListener(new ActionListener() {
	public void actionPerformed(ActionEvent e) {
		quesF1.setText(((BangladeshAffairs)p).getQ1());
		quesF2.setText(((BangladeshAffairs)p).getQ2());
		quesF3.setText(((BangladeshAffairs)p).getQ3());
		optionF1.setText(((BangladeshAffairs)p).getO1());
		optionF2.setText(((BangladeshAffairs)p).getO2());
		optionF3.setText(((BangladeshAffairs)p).getO3());
...
lblNewLabel_1.setBounds(10, 420, 107, 29);
...
btnBack.setFont(new Font("Segoe UI Black", Font.PLAIN, 16));
btnBack.setBackground(Color.GREEN);
btnBack.setBounds(64, 482, 123, 29);
