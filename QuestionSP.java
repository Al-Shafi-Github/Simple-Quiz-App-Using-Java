...
public class QuestionSP extends JFrame {
	...
	public static void main() {
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					QuestionSP frame = new QuestionSP();
	 ...
	 * Create the frame.
	 */
	public QuestionSP() throws IOException {
		p = new Sports();
		setTitle("Sports");
		setIconImage(Toolkit.getDefaultToolkit()
				.getImage(QuestionSP.class.getResource("/javax/swing/plaf/metal/icons/ocean/computer.gif")));
		...
		confirmBut.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				String A1 = ((Sports) p).getA1();
				String A2 = ((Sports) p).getA2();
				String A3 = ((Sports) p).getA3();
		...
		confirmBut.setBackground(Color.GREEN);
		confirmBut.setFont(new Font("Segoe UI Black", Font.PLAIN, 16));
		confirmBut.setBounds(352, 482, 141, 29);
		contentPane.add(confirmBut);
		...
		quesBut.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				quesF1.setText(((Sports) p).getQ1());
				quesF2.setText(((Sports) p).getQ2());
				quesF3.setText(((Sports) p).getQ3());
				optionF1.setText(((Sports) p).getO1());
				optionF2.setText(((Sports) p).getO2());
				optionF3.setText(((Sports) p).getO3());
		...
		button.setBounds(68, 482, 123, 29);
